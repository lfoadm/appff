...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="{{url('/')}}/assets/img/sidebar-1.jpg"> <!-- Tip 1: You can change the color of the sidebar using: data-color="purple | azure | green | orange | danger" Tip 2: you can also add an image using data-image tag-->
      <div class="logo">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          {{--<li class="nav-item">
            <a class="nav-link" href="{{ route('instrutores.index') }}">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="">Novo usuário cadastrado - José Alves</a>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            </script>, Todos direitos reservados <i class="material-icons">edit</i> by
            <a href="" target="_blank">LFOADM</a> Desenvolvedor.
          </div>
        </div>
      </footer>
